...
import akshitaImage from './assets/transformations/akshita-single.jpg';
...
import savitriImage from './assets/transformations/savitri-kashyap.jpg';
import kashishImage from './assets/transformations/kashish-picture.jpg';
import mimansaBeforeImage from './assets/transformations/mimansa-before.jpeg';
import mimansaAfterImage from './assets/transformations/mimansa-after.jpeg';
import sheetalBeforeImage from './assets/transformations/sheetal-before.jpg';
import sheetalAfterImage from './assets/transformations/sheetal-after.jpg';
...
export const defaultContent = {
  ...
  nav: [
    ...
    { id: 'enquiry', label: 'Enquiry', href: '#enquiry' }
  ],
  hero: {
  ...
  transformations: {
    ...
    items: [
      { name: 'Parthvi Singh', location: 'Jodhpur, Age 28', program: 'Strength & Toning', image: parthviAfterImage, beforeImage: parthviBeforeImage, afterImage: parthviAfterImage, beforePosition: '38% 44%', afterPosition: 'center 26%', videoSrc: '/videos/parthvi-pullup.mp4', duration: '8 months', year: '2026', testimonial: "I had a great experience training with Seema. She kept me accountable and consistent, while constantly motivating and encouraging me throughout my journey. Within 3-4 months, I was able to do push-ups, and within 8 months, I achieved a pull-up. She was extremely encouraging, patient, and genuinely invested in helping you improve. Highly recommend her!", stats: [{ value: 'Pull-up', label: 'Achieved' }, { value: 'Push-ups', label: 'In 3-4 Months' }, { value: 'Consistent', label: 'Training' }] },
      { name: 'Vandana Taneja', location: 'Jodhpur, Age 28', program: 'Posture Improvement & Toning', image: vandanaAfterImage, beforeImage: vandanaBeforeImage, afterImage: vandanaAfterImage, beforePosition: 'center 24%', afterPosition: 'center 25%', duration: 'Over 1 year', year: '2026', testimonial: "I've been training with her for over a year, and she's helped me improve my posture and build my confidence. She is attentive to every exercise, set, and rep, which has really improved my technique and consistency. Her guidance, encouragement, and attention to detail have made a big difference in my fitness journey.", stats: [{ value: 'Better', label: 'Posture' }, { value: 'Toned', label: 'Body' }, { value: 'Built', label: 'Confidence' }] },
      { name: 'Savitri Kashyap', location: 'Jodhpur, Age 57', program: 'Pain-Free Strength & Confidence', image: savitriImage, imagePosition: 'center 28%', videoSrc: '/videos/savitri-testimonial.mp4', duration: '3 months', year: '2026', testimonial: 'When I started, I lacked confidence and even basic squats were difficult due to knee pain. Seema helped me progress slowly and safely, focusing on mobility, strength, and proper form without ever pressuring or comparing me. Today, I can do weighted goblet squats, hold a 7-minute plank, and comfortably train on the elliptical for 60 minutes. Most importantly, my back and cervical pain have reduced significantly, and I feel stronger, more active, and genuinely enjoy going to the gym.', stats: [{ value: '7 min', label: 'Plank' }, { value: '60 min', label: 'Elliptical' }, { value: 'Pain-Free', label: 'Training' }] },
      { name: 'Jigeesha Jain', location: 'Jodhpur, Age 24', program: 'Weight Loss & Toning', image: jigeeshaAfterImage, beforeImage: jigeeshaBeforeImage, afterImage: jigeeshaAfterImage, beforePosition: 'center 25%', afterPosition: 'center 28%', duration: '2 months', year: '2026', testimonial: "Ma'am, these 2 months with you have been such an amazing journey! You didn't just train my body, you taught me to understand it, trust it and take care of it. From workouts to nutrition, I've learnt so much and gained confidence I never thought I would. Thank you for your patience, constant motivation and for making fitness feel so much more comfortable and fun. Aapke saath training karna was truly a learning experience I'll always cherish!", stats: [{ value: '5kg', label: 'Weight Lost' }, { value: '3.6%', label: 'Fat Drop' }, { value: 'Toning', label: 'Focus' }] },
      { name: 'Akshita Sharma', location: 'Singapore, Age 26', program: 'Back-Friendly Strength Workouts', image: akshitaImage, imagePosition: 'center 38%', duration: '6 months', year: '2026', testimonial: 'Training with Seema really helped improve my lower back pain - the workouts were adjusted perfectly to my body and needs, and I could genuinely feel the difference. She also made the sessions enjoyable with well-balanced gym exercises that kept me motivated.', stats: [{ value: 'Better', label: 'Lower Back' }, { value: '6', label: 'Months' }, { value: 'Strength', label: 'Improved' }] },
      { name: 'Tarnija Mohan Rathore', location: 'Jodhpur, Age 36', program: 'Weight Loss', image: tarnijaAfterImage, beforeImage: tarnijaBeforeImage, afterImage: tarnijaAfterImage, beforePosition: 'center 24%', afterPosition: 'center 25%', duration: '3 months', year: '2026', testimonial: "Thank you Seema Suthar for training. It's been only 3 weeks and changes can be seen in my body. I wore saare after 3 weeks of training and it felt so amazing.", stats: [{ value: '5.4kg', label: 'Weight Drop' }, { value: '3.2%', label: 'Fat Drop' }, { value: '3', label: 'Months' }] },
      { name: 'Dr Mimansa Kashyap', location: 'Jodhpur, Age 30', program: 'Strength & Energy', image: mimansaAfterImage, beforeImage: mimansaBeforeImage, afterImage: mimansaAfterImage, beforePosition: 'center 24%', afterPosition: 'center 30%', duration: '3 months', year: '2026', testimonial: 'Hey Seema I was just casually lifting my baby and realised that how much strength I have gained in last 3 months, let alone how energetic I feel throughout the day. All thanks to your training and guidance.', stats: [{ value: 'Stronger', label: 'Daily Lifting' }, { value: 'High', label: 'Energy' }, { value: '3', label: 'Months' }] },
      { name: 'Kashish Banthia', location: 'Jodhpur, Age 24', program: 'Personalized Fitness Training', image: kashishImage, imagePosition: 'center 38%', duration: 'Ongoing', year: '2026', testimonial: "My trainer Seema ma'am has been a great mentor throughout my journey. She has an incredible deep understanding of fitness and how the body works. From day one, she took the time to personalize my training sessions, tailoring them to my goals and needs. What really stands out is her ability to keep every session fresh and exciting - she constantly introduces variety, so I never feel like I'm stuck in a routine. Whether it's strength training, flexibility, or cardio, she knows exactly what to focus on to help me progress. Her dedication and expertise have made a huge difference in my fitness journey. Highly recommend!", stats: [{ value: 'Custom', label: 'Sessions' }, { value: 'Varied', label: 'Training' }, { value: 'Progress', label: 'Focused' }] },
      { name: 'Sheetal Singh', location: 'Jodhpur, Age 28', program: 'Strength & Consistency', image: sheetalAfterImage, beforeImage: sheetalBeforeImage, afterImage: sheetalAfterImage, beforePosition: 'center 24%', afterPosition: 'center 26%', duration: '6 months', year: '2026', testimonial: 'I always found it difficult to stay consistent and motivated with my workouts. But training with Seema has completely changed that for me. She has helped me become much stronger, and somehow makes every session challenging yet so much fun that I actually look forward to going to the gym, even after a long workday. Thank you, Seema, for keeping me motivated and making fitness something I genuinely enjoy!', stats: [{ value: 'Stronger', label: 'Strength Built' }, { value: '6', label: 'Months' }, { value: 'Consistent', label: 'Gym Habit' }] }
    ],
